...
root.title("Hypertension and Calculator Info")
...
def show_hypertension_facts():
    ...
    fact_label = Label(root, text=facts, wraplength=350, justify="left")
...
hypertension_button = Button(root, text="What is Hypertension?", command=show_hypertension_facts)

hypertension_button.pack(pady=20)

 

calculator_button = Button(root, text="How does the Hypertension Calculator work?", command=show_calculator_facts)
